  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start rtl:justify-end">
              ...
              <a href="/dashboard" className="flex ms-2 md:me-24">
                <span className="self-center text-xl text-blue-500 font-semibold sm:text-2xl whitespace-nowrap dark:text-white">
                  WebStockClient
                </span>
              </a>
            </div>
            <div className="flex items-center">
              <div className="flex items-center ms-3">
                <div>
                  <button
                    type="button"
                    className="flex text-sm bg-blue-500 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
                    aria-expanded="false"
      ...
      {sidebarOpen && (
        <div
          aria-hidden="true"
          className="fixed inset-0 w-full h-full backdrop-blur-sm bg-white/30 z-20"
